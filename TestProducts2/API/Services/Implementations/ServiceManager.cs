...
namespace API.Services.Implementations
{
    public class ServiceManager : IServiceManager
    {
        ...
        private readonly Lazy<IMiniService> _miniService;
        ...
        public ServiceManager(IRepositoryManager repositoryManager, IMapper mapper)
        {
            ...
            _miniService = new Lazy<IMiniService>(() => new MiniService(repositoryManager, mapper));
        ...
        public IMiniService MiniService => _miniService.Value;
